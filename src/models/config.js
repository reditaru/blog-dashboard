...
const config = {
    ...
    actions: {
        async getConfig({
            ...
            if (data.success) {
                commit(TYPES.config.mutations.UPDATE_CONFIG, {
                    config: data.res
                }, {
                    root: true
                });
                commit(TYPES.config.mutations.OPERATION_SUCCESS, null, {
                    root: true
                });
            }
        },
        async updateConfig({
            ...
            commit(TYPES.config.mutations.OPERATION_REQUEST, null, {
                root: true
            });
            ...
            if (data.success) {
                ...
                commit(TYPES.config.mutations.OPERATION_FAIL, {
                    msg: data.msg
                }, {
                    root: true
                });
