...
const { UPDATE_ALL_ARTICLE, UPDATE_ARTICLE, OPERATION_FAIL, OPERATION_REQUEST, OPERATION_SUCCESS, DELETE_ARTICLE, SET_EDIT_ID, SET_OPERATION } = PLAIN_TYPES.article.mutations;
const article = {
    namespaced: true,
    state: {
        articles: {},
    ...
    actions: {
        async getArticles({
            ...
            if (data.success) {
                commit(TYPES.article.mutations.UPDATE_ALL_ARTICLE, {
                    articles: data.res
                }, {
                    root: true
                });
        ...
        async getArticle({
            ...
            if (data.success) {
                commit(TYPES.article.mutations.UPDATE_ARTICLE, {
                    article: data.res
                }, {
                    root: true
                });
        ...
        async createArticle({
            ...
            commit(TYPES.article.mutations.OPERATION_REQUEST, null, {
                root: true
            });
            ...
            if (data.success) {
                ...
                commit(TYPES.article.mutations.OPERATION_SUCCESS, null, {
                    root: true
                });
            } else {
                commit(TYPES.article.mutations.OPERATION_FAIL, {
                    msg: data.msg
                }, {
                    root: true
                });
        ...
        async deleteArticle({
            ...
            if (data.success) {
                commit(TYPES.article.mutations.DELETE_ARTICLE, {
                    id: payload.id
                }, {
                    root: true
                })
